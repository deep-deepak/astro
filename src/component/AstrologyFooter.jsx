                        ...
                        <div className="d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h5 className="mb-0" style={{
                                    ...
                                    fontSize: '1.5rem',
                                    fontWeight: '600'
                                }}> Astrologer Gayatri Devi</h5>
                                <p className="mb-0" style={{
                                    fontSize: '0.85rem',
                                    color: '#a8dadc',
                                    fontStyle: 'italic'
                                }}>Certified Jyotish Astrologer</p>
                            </div>
                        </div>
                    ...
                    <Col xs={12} sm={6} lg={2} className="mb-4 mb-lg-0">
                        ...
                        <ul className="list-unstyled">
                            {[
                                ...
                                <li key={index} className="mb-3">
                                    <div className="d-flex align-items-center" style={{ color: '#e0e0e0', fontSize: '0.95rem' }}>
                                        <span style={{
                                            marginRight: '8px',
                                            color: '#06d6a0',
                                            fontSize: '1.2rem'
                ...
                <Row className="mt-5 pt-4" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                    <Col xs={12} className="text-center">
                        <p style={{
                            ...
                            <a href="#" className="text-decoration-none ms-2" style={{ color: '#ffd166' }}>Privacy Policy</a> |
                            <a href="#" className="text-decoration-none ms-2" style={{ color: '#ffd166' }}>Terms of Service</a>
                        </p>
                    </Col>
                </Row>
            </Container>
